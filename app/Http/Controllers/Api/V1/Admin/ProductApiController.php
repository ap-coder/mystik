...
class ProductApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new ProductResource(Product::with(['product_type', 'categories', 'tags'])->get());
    }
    ...
    public function store(StoreProductRequest $request)
    {
        ...
        if ($request->input('attachments', false)) {
            $product->addMedia(storage_path('tmp/uploads/' . $request->input('attachments')))->toMediaCollection('attachments');
        }
    ...
    public function show(Product $product)
    {
        ...
        return new ProductResource($product->load(['product_type', 'categories', 'tags']));
    }
    ...
    public function update(UpdateProductRequest $request, Product $product)
    {
        ...
        if ($request->input('attachments', false)) {
            if (!$product->attachments || $request->input('attachments') !== $product->attachments->file_name) {
