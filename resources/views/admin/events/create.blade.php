...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="content_area">{{ trans('cruds.event.fields.content_area') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.event.fields.content_area_helper') }}</span>
            </div>
            <div class="form-group">
