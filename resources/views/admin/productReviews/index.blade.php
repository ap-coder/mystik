...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-ProductReview">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($productReviews as $key => $productReview)
                        <tr data-entry-id="{{ $productReview->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $productReview->published ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-ProductReview:not(.ajaxTable)').DataTable({ buttons: dtButtons })
