        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.product.fields.attachments') }}
                        </th>
                        <td>
                            @foreach($product->attachments as $key => $media)
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.product.fields.fb_title') }}
                        </th>
                        <td>
                            {{ $product->fb_title }}
                        </td>
...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#products_partners" role="tab" data-toggle="tab">
                {{ trans('cruds.partner.title') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#products_posts" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" role="tabpanel" id="products_partners">
            @includeIf('admin.products.relationships.productsPartners', ['partners' => $product->productsPartners])
        </div>
        <div class="tab-pane" role="tabpanel" id="products_posts">
            @includeIf('admin.products.relationships.productsPosts', ['posts' => $product->productsPosts])
        </div>
    </div>
</div>
