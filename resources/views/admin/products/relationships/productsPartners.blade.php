...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-productsPartners">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($partners as $key => $partner)
                        <tr data-entry-id="{{ $partner->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $partner->published ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-productsPartners:not(.ajaxTable)').DataTable({ buttons: dtButtons })
