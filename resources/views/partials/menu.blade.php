<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
            ...
            <li class="c-sidebar-nav-dropdown">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('product_type_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.product-types.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/product-types") || request()->is("admin/product-types/*") ? "active" : "" }}">
                    ...
                    @can('product_review_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.product-reviews.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/product-reviews") || request()->is("admin/product-reviews/*") ? "active" : "" }}">
            ...
            <li class="c-sidebar-nav-dropdown">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('discussion_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.discussions.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/discussions") || request()->is("admin/discussions/*") ? "active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
        ...
        @can('partner_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.partners.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/partners") || request()->is("admin/partners/*") ? "active" : "" }}">
